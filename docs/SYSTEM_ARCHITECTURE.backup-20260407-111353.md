...
- **Pick has Android deployment** alongside Desktop, <!-- iOS removed - too complex for MVP -->, Web, TUI
...
**Purpose:** Multi-platform penetration testing tool executor

**Responsibilities:**
- **Tool Execution:** 3000+ BlackArch tools on-demand
- **Platform Abstraction:** Desktop, Android, <!-- iOS removed - too complex for MVP -->, Web, TUI
...
- BlackArch Linux rootfs (embedded)
- Platform-specific implementations (desktop, android, ios)
