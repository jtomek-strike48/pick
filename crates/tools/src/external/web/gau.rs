//! GAU - Get All URLs from AlienVault, Wayback, Common Crawl, URLScan
...
impl PentestTool for GauTool {
    ...
    async fn execute(&self, params: Value, _ctx: &ToolContext) -> Result<ToolResult> {
        execute_timed(|| async move {
            ...
            ensure_tool_installed(&platform, "gau", "gau").await?;
            ...
            let result = platform
                .execute_command("gau", &args_refs, Duration::from_secs(timeout_secs))
                .await?;
